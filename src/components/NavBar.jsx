...
function NavBar() {
  ...
  return (
    <header className='flex flex-col md:flex-row md:items-center justify-between px-6 py-4 bg-sinner text-saint shadow-lg gap-y-2'>
      ...
      <nav className='flex flex-col md:flex-row md:items-center gap-y-2 md:gap-x-4 text-base md:text-sm relative'>
        <Link to='/' className='hover:text-goldleaf transition'>
          Home
        </Link>
        <Link to='/menu' className='hover:text-goldleaf transition'>
          Menu
        </Link>
        <Link to='/story' className='hover:text-goldleaf transition'>
          Our Story
        </Link>
        ...
        <div className='relative' ref={dropdownRef}>
          ...
          {customOpen && (
            <div className='absolute left-0 mt-2 bg-sinner border border-goldleaf rounded shadow-lg z-50 w-56'>
              <Link
                to='/specialty-cakes'
                className='block px-4 py-2 hover:bg-goldleaf hover:text-sinner transition'>
                Specialty Cakes
              </Link>
              <Link
                to='/custom-cakes'
        ...
        <Link to='/contact' className='hover:text-goldleaf transition'>
          Contact
        </Link>
      </nav>
    </header>
